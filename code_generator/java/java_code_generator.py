...
class JavaClass:
    ...
    def _add_class_definition(self, file_lines):
        class_line = "public class " + self._name
        if len(self.extensions) != 0:
            class_line += " extends "
            for extension in self.extensions:
                class_line += extension
        class_line += " {"
        add_line(file_lines, self._tab_offset, class_line)
...
class MethodDivider:
    ...
    def write(self, file_lines):
        ...
        add_line(file_lines, self._tab_offset, line)
        add_line(file_lines, self._tab_offset, center_line)
        add_line(file_lines, self._tab_offset, line)
...
class JavaMethod:
    ...
    def _add_method_signature(self, file_lines):
        ...
        for param in self.param:
            ...
            i += 1
        method_line += ") {"
        add_line(file_lines, self._tab_offset, method_line)
...
def add_line(file_lines, tabs, text):
    """
